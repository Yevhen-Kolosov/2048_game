...
"use strict";
const { changeCellClass } = require("e81bd55f4d05a566");
const { addNewNumber } = require("575b2ccc4827c7a0");
const { handleAction } = require("cbee0984209af5d8");
const { isTurnPossible } = require("bd12434bcba1f543");
const CONTROLS = [
    "ArrowUp",
    "ArrowDown",
    "ArrowLeft",
...
mainButton.addEventListener("click", ()=>{
    ...
    addNewNumber(cells);
    addNewNumber(cells);
    for(const gameEvent in messages)if (!messages[gameEvent].classList.contains("hidden")) messages[gameEvent].classList.add("hidden");
    document.addEventListener("keydown", game2048);
});

},{"e81bd55f4d05a566":"4fQBt","575b2ccc4827c7a0":"gj0u9","cbee0984209af5d8":"5ppFn","bd12434bcba1f543":"knQr5"}],"4fQBt":[function(require,module,exports) {
"use strict";
...
},{}],"gj0u9":[function(require,module,exports) {
"use strict";
const { changeCellClass } = require("585255ddc8d12326");
...
},{"585255ddc8d12326":"4fQBt"}],"5ppFn":[function(require,module,exports) {
"use strict";
...
},{}],"knQr5":[function(require,module,exports) {
"use strict";
...
},{}]},["l1XHo","3cYfC"], "3cYfC", "parcelRequireaa7d")
